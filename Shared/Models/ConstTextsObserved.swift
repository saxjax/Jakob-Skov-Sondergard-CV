...
class ConstTextsObserved:ObservableObject{
  ...
  @Published var competencesText = """
                          ...
                          Competencer, erfaring og uddannelse

                          Underbyd dit resume
                          Brug storytelling Problem Aktion og Resultat
                          Beskriv relevante opgaver fra min uddannelse, eller arbejde

                          Problemet: fortæl om opgavens kompleksitet så det er klart at der var reelle udfordringer

                          Aktionen: Hvilke overvejelser havde du, og hvilken aktion blev valgt, hvad var dit bidrag i teamet
